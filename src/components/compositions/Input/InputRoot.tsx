...
export const inputContainerVariants = tv({
  ...
  variants: {
    ...
    variant: {
      newSearch:
        'rounded-full text-interlis-inputs-500 border-interlis-inputs-200 text-base',
      floatLabel: 'peer placeholder-transparent',
      error:
        'border-red-500/75 hover:border-red-600 focus:border-red-500 focus:ring-red-500',
      success:
        'border-green-500/75 hover:border-green-600 focus:border-green-500 focus:ring-green-500',
      ...
      forms:
        'text-interlis-fonts-300 border border-interlis-tables-300 text-sm py-1 font-normal rounded-md',
    },
  },
  defaultVariants: {
    containerSize: 'sm',
