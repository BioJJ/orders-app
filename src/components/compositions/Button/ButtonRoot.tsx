...
export const buttonVariant = tv({
  ...
  variants: {
    ...
    variant: {
      ...
      secondary: 'bg-interlis-buttons-500 hover:bg-interlis-hover-buttons-400',
      outline:
        'bg-transparent hover:bg-gray-100 active:bg-gray-200 border border-gray-300 text-gray-500',
      outlineTwo:
        'bg-interlis-buttons-100 hover:bg-gray-200 active:bg-gray-200 border border-gray-300 text-interlis-buttons-700 font-bold',
      primary_financial:
        'bg-interlis-buttons-500 hover:bg-indigo-800 active:bg-indigo-900 dark:bg-indigo-500 dark:hover:bg-indigo-600 dark:active:bg-indigo-700',
      success:
        'bg-interlis-buttons-400 hover:bg-interlis-hover-buttons-500 active:bg-interlis-pressed-buttons-400',
      successWithMore:
      ...
      sample:
        'px-4 py-1 bg-interlis-buttons-500 h-8 hover:bg-interlis-hover-buttons-400 font-bold',
      backArrow:
...
export function ButtonRoot({
  ...
  return (
    <button
      type={type}
      className={cn(
        buttonVariant({ variant, size, width, className }),
        className,
      )}
      {...props}
    >
