...
import { inputVariants } from "../compositions/Input/InputElement";
import { inputContainerVariants } from "../compositions/Input/InputRoot";
import { InputForm } from "../compositions/Inputs/Input";
import { FormErrorMessage } from "../compositions/FormErrorMessage";
            ...
            >
              {label && (
                ...
                >
                  {label}
                  {required && (
                    <span className="text-interlis-fonts-200"> * </span>
                  )}
                </label>
              )}
              <div>
                <InputForm
                  ...
                  value={
                    customValue ??
                    (formatForCurrency ? formatCurrency(value) : value)
                  }
                  onChange={
                    formatForCurrency
                      ? handleFormatCurrencyOnChange
                      : handleOnChange
                  }
